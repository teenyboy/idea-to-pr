...
**Output artifact**: `.claude/skills/idea-to-pr/artifacts/review/comment-quality-findings.md`
...
Write to `.claude/skills/idea-to-pr/artifacts/review/comment-quality-findings.md`:
...
- **Artifact**: `.claude/skills/idea-to-pr/artifacts/review/comment-quality-findings.md`
```
