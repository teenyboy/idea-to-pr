...
```
❌ Plan context not found at .claude/skills/idea-to-pr/artifacts/plan-context.md
...
Write to `.claude/skills/idea-to-pr/artifacts/plan-confirmation.md`:
...
Confirmation written to: `.claude/skills/idea-to-pr/artifacts/plan-confirmation.md`
...
Details written to: `.claude/skills/idea-to-pr/artifacts/plan-confirmation.md`
```
