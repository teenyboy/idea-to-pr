...
Write to `.claude/skills/idea-to-pr/artifacts/validation.md`:
...
Results written to: `.claude/skills/idea-to-pr/artifacts/validation.md`
...
Partial results written to: `.claude/skills/idea-to-pr/artifacts/validation.md`
```
