...
```bash
cat .claude/skills/idea-to-pr/artifacts/plan-confirmation.md
```
...
Write to `.claude/skills/idea-to-pr/artifacts/implementation.md`:
...
Progress written to: `.claude/skills/idea-to-pr/artifacts/implementation.md`
