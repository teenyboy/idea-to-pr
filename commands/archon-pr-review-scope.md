...
```bash
if [ -f ".claude/skills/idea-to-pr/artifacts/.pr-number" ]; then
  PR_NUMBER=$(cat .claude/skills/idea-to-pr/artifacts/.pr-number | tr -d '\n' | tr -d ' ')
...
ls -t .claude/skills/idea-to-pr/artifacts/../runs/*/plan-context.md 2>/dev/null | head -1

# Option 2: Issue-based workflow (archon-fix-github-issue)
ls -t .claude/skills/idea-to-pr/artifacts/../runs/*/investigation.md 2>/dev/null | head -1
```
...
sed -n '/## NOT Building/,/^## /p' .claude/skills/idea-to-pr/artifacts/../runs/*/plan-context.md | head -30
```
...
sed -n '/## Scope Boundaries/,/^## /p' .claude/skills/idea-to-pr/artifacts/../runs/*/investigation.md | head -30
```
...
ls -t .claude/skills/idea-to-pr/artifacts/../runs/*/implementation.md 2>/dev/null | head -1
```
...
sed -n '/## Deviations/,/^## /p' .claude/skills/idea-to-pr/artifacts/../runs/*/implementation.md | head -20
```
...
find .claude/skills/idea-to-pr/artifacts/../reviews/pr-* -maxdepth 0 -mtime +7 -exec rm -rf {} \; 2>/dev/null || true
```
