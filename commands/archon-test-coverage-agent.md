...
**Output artifact**: `.claude/skills/idea-to-pr/artifacts/review/test-coverage-findings.md`
...
Write to `.claude/skills/idea-to-pr/artifacts/review/test-coverage-findings.md`:
...
- **Artifact**: `.claude/skills/idea-to-pr/artifacts/review/test-coverage-findings.md`
```
