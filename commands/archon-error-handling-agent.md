...
**Output artifact**: `.claude/skills/idea-to-pr/artifacts/review/error-handling-findings.md`
...
Write to `.claude/skills/idea-to-pr/artifacts/review/error-handling-findings.md`:
...
- **Artifact**: `.claude/skills/idea-to-pr/artifacts/review/error-handling-findings.md`
```
