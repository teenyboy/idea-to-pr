...
**Output**: `.claude/skills/idea-to-pr/artifacts/plan.md`
...
Write to `.claude/skills/idea-to-pr/artifacts/plan.md`:
...
- [ ] Plan file written to `.claude/skills/idea-to-pr/artifacts/plan.md`
...
**File**: `.claude/skills/idea-to-pr/artifacts/plan.md`
**Workflow ID**: `idea-to-pr`
...
- **ARTIFACT_WRITTEN**: Plan saved to `.claude/skills/idea-to-pr/artifacts/plan.md`
