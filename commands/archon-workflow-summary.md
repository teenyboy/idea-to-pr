...
ls -la .claude/skills/idea-to-pr/artifacts/

# Read each one
for file in .claude/skills/idea-to-pr/artifacts/*.md; do
  echo "=== $file ==="
  cat "$file"
done
```
...
ls -la .claude/skills/idea-to-pr/artifacts/review/

# Read each review finding
for file in .claude/skills/idea-to-pr/artifacts/review/*.md; do
  echo "=== $file ==="
  cat "$file"
done
```

**Expected review artifacts** (in `runs/idea-to-pr/review/`):
...
Write to `.claude/skills/idea-to-pr/artifacts/workflow-summary.md`:
...
- Summary: `.claude/skills/idea-to-pr/artifacts/workflow-summary.md`
- All artifacts: `.claude/skills/idea-to-pr/artifacts/`
```
