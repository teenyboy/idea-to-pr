...
**Output artifact**: `.claude/skills/idea-to-pr/artifacts/review/code-review-findings.md`
...
Write to `.claude/skills/idea-to-pr/artifacts/review/code-review-findings.md`:
...
- **Artifact**: `.claude/skills/idea-to-pr/artifacts/review/code-review-findings.md`
```
...
```bash
cat .claude/skills/idea-to-pr/artifacts/review/code-review-findings.md | head -20
```
