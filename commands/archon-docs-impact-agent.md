...
**Output artifact**: `.claude/skills/idea-to-pr/artifacts/review/docs-impact-findings.md`
...
Write to `.claude/skills/idea-to-pr/artifacts/review/docs-impact-findings.md`:
...
- **Artifact**: `.claude/skills/idea-to-pr/artifacts/review/docs-impact-findings.md`
```
